...
<body>
<br>
<center><h1 class="v">Install ipa Page</h1></center>

<table style="margin-left: 50px" width="98%">
    <tr>
        <td width="35%">
            <br><a href="${ctx}/devicechose" style="font-size:30pt;">Pack Page</a><br><br><br><br>
            <a href="http://${systemip}:8080/down/iostools.html" style="font-size:30pt;">Ios Tools
                Page</a><br><br><br><br>
            <a href="${ctx}/iosreadydown" style="font-size:30pt;">ready_package</a><br><br><br><br>
        </td>
        <td class="v3" width="65%" style="text-align: left">
            文件名:
            <input type="text" style="font-size: 30px;height: 50px;width: 250px" id="search_context" width="10px"
                   value="${context_search}">
            <input type="button" style="font-size: 30px;height: 50px;width: 150px" id="search_button" onclick="search()"
                   value="查询">
            <br><br>
          ...
          --%>
            ...
            <input type="text" style="font-size: 30px;height: 50px;width: 250px" id="div_jump_page" width="10px"
                   value="${cur_page_num}">页<br><br>
...
<table style='width:95%' align="center">
    <br>
    <tr>
        <td width="95%" height="200px" align="center"><a class="v" href="http://${systemip}:8080/downipa/ca/app.pem"
                                                         style="font-size:30pt;">Click to Trust Me First!<br>(From the
            Root Authority)</a></td>
    </tr>
    <br>
    ...
    <c:forEach var="item" items="${iosLogs}">
        ...
        <tr>
            <td width="85%" height="200px"><p class='v'><a
                    href="itms-services://?action=download-manifest&url=https://${systemip}:8443/downipa/${downipa_filename}/${item.file_name}/online/manifest.plist">${item.file_name}</a><br>
            </p></td>
            <td width="10%" height="200px"><p class='v1'><a
                    href="/download?file_url=${item.store_root_path}/${item.store_path}/${item.file_name}/online/${item.product_name}.ipa">Down</a>
            </p></td>
        </tr>
