...
<body>
<br>
<center><h1 class="v">Down apk Page</h1></center>

<table style="margin-left: 20px" width="98%">
    <tr>
        <td width="35%">
            <br><a href="${ctx}/devicechose" style="font-size:30pt;">Pack Page</a><br><br><br><br><br><br>
            <a href="http://${systemip}:8080/down/androidtools.html" style="font-size:30pt;">Android Tools
                Page</a><br><br><br><br>
...
<table style='width:100%' align="center">
    ...
    <c:forEach items="${androidLogs}" var="items">
        ...
        <tr>
            <th height="200px"><p class='v'><a
                    href="/download?file_url=${items.store_root_path}/${items.store_path}/${items.file_name}/online/${items.product_name}.apk">${items.file_name}</a><br>
            </p></th>
        </tr>
