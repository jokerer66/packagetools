    ...
    <div class="table-b">
        <table id="mytable" class="gridtable" width="80%">
            ...
            <tr>
                ...
                <td><p class="text_yellow">修改项目的配置项<br>可使用参数$local_path表示下载下来的代码根目录<br>$svn_version表示当前svn路径下最新的svn号<br>$svn_date表示具体svn信息<br>$packinfo_onoff表示服务器类型(0/1/2)
                </p></td>
            </tr>
            ...
            <tr>
                ...
                <td><p class="text_yellow">
                    打出来的包的移动等操作<br>可使用参数$local_path表示下载下来的代码根目录<br>$svn_version表示当前svn路径下最新的svn号<br>$svn_date表示具体svn信息<br>$packinfo_onoff表示服务器类型(0/1/2)
                </p></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="text2" type="text" id="text_iosapp_path"
                           value="/build/XXX/Build/Products/Release-iphoneos/XXX.app"></td>
                <td><p class="text_yellow">(android不需要填写)</p></td>
            </tr>
